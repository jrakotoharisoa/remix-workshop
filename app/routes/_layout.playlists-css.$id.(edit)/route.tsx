...
import { ActionArgs, json, LoaderArgs, LinksFunction } from "@remix-run/node";
...
import scopedStylesheet from "./toto.css";

export const links: LinksFunction = () => [{ rel: "stylesheet", href: scopedStylesheet }];
